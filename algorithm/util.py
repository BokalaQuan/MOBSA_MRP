...
def read_json_as_list(topo, type):
    path = os.getcwd() + '\\solution\\' + topo + '\\pf_' + type + '.json'
    list_ = []
...
def write_list_to_json(topo, type, solutions):
    path = os.getcwd() + '\\solution\\' + topo + '\\pf_' + type + '.json'
...
def write_performance(name, topo, type, lst):
    path = os.getcwd() + '\\solution\\' + topo + '\\' + name + '_' + type + '.json'
